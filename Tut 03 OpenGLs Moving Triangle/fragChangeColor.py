# Mario Rosasco, 2016
# adapted from fragChangeColor.cpp, Copyright (C) 2010-2012 by Jason L. McKesson
...
def initializeProgram():
    ...
    shaderList.append(loadShader(GL_FRAGMENT_SHADER, "calcColor.frag"))
    ...
    glUniform1f(fragLoopDurUnf, 10.0)
    glUseProgram(0)
